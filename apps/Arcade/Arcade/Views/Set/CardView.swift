...
class CardView: UIView
{
    ...
    var card: SetCard? {
        didSet {
            ...
            case SetCard.Variant.v1: shape = CardView.Shape.diamond
            case SetCard.Variant.v2: shape = CardView.Shape.oval
            case SetCard.Variant.v3: shape = CardView.Shape.squiggle
            }
            
            switch card!.feature2 {
            case SetCard.Variant.v1: style = CardView.Style.solid
            case SetCard.Variant.v2: style = CardView.Style.striped
            case SetCard.Variant.v3: style = CardView.Style.unfilled
            }
            
            switch card!.feature3 {
            case SetCard.Variant.v1: color = CardView.Color.green
            case SetCard.Variant.v2: color = CardView.Color.purple
            case SetCard.Variant.v3: color = CardView.Color.red
            }
            
            switch card!.feature4 {
            case SetCard.Variant.v1: number = CardView.Number.one
            case SetCard.Variant.v2: number = CardView.Number.two
            case SetCard.Variant.v3: number = CardView.Number.three
            }
        }
    }
